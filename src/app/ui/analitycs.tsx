            ...
            <div className="mx-auto max-w-screen-xl px-4 md:px-6 grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
                <div className="md:col-span-6 space-y-6">
                    <div className="flex flex-col gap-4">
                        <span className="text-xs md:text-sm text-gray-400 uppercase tracking-[0.25em]">Beneficios</span>
                        <span className="inline-flex w-fit items-center rounded-full bg-white/5 px-3 py-1 text-xs md:text-sm text-gray-300 ring-1 ring-white/10 backdrop-blur-md">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5 pt-4">
                        {[
                            ...
                            <div key={idx} className="flex items-start gap-3 p-2 rounded-xl hover:bg-white/5 transition-colors">
                    ...
                    <div className="relative w-full max-w-md">
                        ...
                        <div className="relative rounded-3xl border border-white/10 bg-white/5 backdrop-blur-md px-6 pt-6 pb-5 shadow-2xl">
                            <div className="mb-6 flex items-center justify-between">
                                <div>
                                    <p className="text-xs uppercase tracking-[0.25em] text-gray-400">Panel</p>
                                    <p className="text-sm md:text-base font-medium text-white">Rendimiento de ventas</p>
                                </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-xl font-semibold text-white">S/ 32,540</p>
                                </div>
                        ...
                        <div className="mt-8 rounded-3xl px-6 py-6 text-center shadow-lg bg-white/5 border border-white/10 backdrop-blur-md">
                            <h3 className="text-base md:text-lg font-semibold text-white">Estrategias para mejorar tus resultados</h3>
