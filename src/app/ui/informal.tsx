      ...
      <div className="mx-auto max-w-screen-xl px-4 md:px-6 grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
        <div className="md:col-span-6 space-y-5">
          ...
          <p className="text-gray-400 text-sm md:text-base">
            ...
            Funciona en tu celular <span className="font-medium text-white">Android</span> o <span className="font-medium text-white">iOS</span> y puedes imprimir <span className="font-medium text-white">boletas internas en ticketera</span> si lo necesitas.
            Cuando quieras formalizarte, migramos tu información para emitir comprobantes electrónicos a SUNAT.
          </p>
          <div className="flex items-center gap-3 flex-wrap">
            <span className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-xs bg-white/10 text-white border border-white/10 backdrop-blur-md">
              <Icon icon="mdi:android" width={16} height={16} /> Android
            </span>
            <span className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-xs bg-white/10 text-white border border-white/10 backdrop-blur-md">
              <Icon icon="mdi:apple" width={16} height={16} /> iOS
            </span>
            <span className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-xs bg-[#f59e0b]/20 text-[#fcd34d] border border-[#f59e0b]/20 backdrop-blur-md">
        ...
        <div className="md:col-span-6">
          <div className="relative rounded-3xl p-6 md:p-8 bg-white/5 border border-white/10 backdrop-blur-md shadow-2xl">
            ...
            <p className="text-sm font-medium mb-3 text-white relative z-10">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm relative z-10">
              {[
                ...
                <div key={idx} className="bg-black/20 border border-white/5 rounded-2xl p-3 hover:bg-black/30 transition-colors">
                  <p className="font-semibold text-xs mb-1 flex items-center gap-2 text-white"><Icon icon={item.icon} /> {item.title}</p>
                  <p className="text-[11px] text-gray-400">{item.desc}</p>
                </div>
              ))}
            </div>
            <div className="mt-5 rounded-2xl p-4 bg-[#22c55e]/10 border border-[#22c55e]/20 relative z-10">
              <p className="text-sm font-medium mb-1 text-[#4ade80]">Arranca rápido con ticketera</p>
