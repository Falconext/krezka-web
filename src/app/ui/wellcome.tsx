    ...
    return (
        <div className="mx-auto max-w-screen-xl grid grid-cols-2 text-[#F6F9FE] mt-16 md:mt-32 gap-10">
            <div className="after:border-r after:absolute relative h-full md:col-span-1 col-span-2">
                <h3 className="text-[#F6F9FE] md:text-[30px] text-[24px] text-center  mb-10">{BRAND.name.toUpperCase()} tiene lo necesario para tí , Sistema MYPE aprobado por la SUNAT, sistemas a medida, paginas webs modernas y rápidas , nuestra experiencia conecta , inspira y convierte</h3>
