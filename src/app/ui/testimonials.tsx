            ...
            <div className="mx-auto max-w-screen-xl px-4 md:px-6">
                <div className="flex items-center justify-between mb-12">
                    ...
                    <div className="hidden md:flex gap-3">
                        <button
                            onClick={handlePrev}
                            className="rounded-full border border-white/10 bg-white/5 p-3 hover:bg-white/10 transition-colors backdrop-blur-md"
                        >
                            <Icon icon="ic:baseline-arrow-back" width={24} height={24} color="#fff" />
                        </button>
                        <button
                            onClick={handleNext}
                            className="rounded-full border border-white/10 bg-white/5 p-3 hover:bg-white/10 transition-colors backdrop-blur-md"
                        >
                            <Icon icon="ic:baseline-arrow-forward" width={24} height={24} color="#fff" />
                        </button>
                    </div>
                </div>
                        ...
                        return (
                            <div
                                ...
                                bg-white/5 border-white/10 backdrop-blur-xl
                                    ${isActive ? "scale-100 border-white/20 shadow-lg" : "opacity-60 blur-[1px] scale-95"}`}
                            >
                                <div className="grid grid-cols-1 md:grid-cols-5 gap-6 items-center">
                                    {/* Left: avatar + name/role */}
                                    <div className="md:col-span-2 flex md:flex-col items-center md:items-start gap-4">
                                        <div className="shrink-0 rounded-full ring-2 ring-white/10 p-1 bg-white/5">
                                    ...
                                    <div className="md:col-span-3 w-full">
                                        <div className="rounded-2xl border border-white/5 p-1 bg-black/20">
                                            <div className="relative rounded-xl border border-white/5 p-5 bg-gradient-to-b from-white/5 to-transparent">
                                                <p className="font-semibold text-lg md:text-xl mb-3 text-white italic">"{testimonial.quote}"</p>
                                                <p className="text-sm text-gray-400 leading-relaxed">{testimonial.description}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
